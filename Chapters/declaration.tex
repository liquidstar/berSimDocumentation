...
\begin{table}[!h]
	...
	\begin{tabular}{l l}
		...
		Signature \dotuline{\hspace{.2cm}\includegraphics[scale=.5]{Graphics/p_sign.pdf}\hspace{.2cm}}& \hspace{3cm} Date: \dotuline{\textit{17/11/2020}} \\
		 & \\
		Litunya Rosemary Omuoma & \hspace{3cm}\textsc{EN271-6661/2015} \\
		Signature \dotuline{\hspace{.2cm}\includegraphics[scale=.5]{Graphics/r_sign.pdf}\hspace{.2cm}}& \hspace{3cm} Date: \dotuline{\textit{17/11/2020}}
	\end{tabular}
\end{table}
\vfill
\begin{center}
